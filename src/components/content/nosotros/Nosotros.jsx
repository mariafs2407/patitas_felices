...
const Nosotros = (props) => {
    return (
        <div  className="container_nosotros">
            <img  className="img_opacidad" src={somos} alt="" />

            <div  className="nosotros_caja_texto  ">
            ...
            <div  className="nosotros_caja_texto  ">
                <h2  className="nosotros_subtitulo">Visión</h2>
            ...
            <img  className="img_opacidad" src={vision} alt="" />

            <img  className="img_opacidad left" src={mision} alt="" />

            <div  className="nosotros_caja_texto   top3 espacio3">
